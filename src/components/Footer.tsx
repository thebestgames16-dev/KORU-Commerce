      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-[#111111] gap-4">
          ...
          <div className="flex gap-6 pointer-events-auto">
            <Link to="/impressum" className="font-dm-mono text-xs text-[#888888] hover:text-[#C8A84B]">Impressum</Link>
            <Link to="/datenschutz" className="font-dm-mono text-xs text-[#888888] hover:text-[#C8A84B]">Datenschutz</Link>
          </div>
        </div>
      </div>
    </footer>
