            ...
            <div className="flex flex-col lg:flex-row items-center gap-20">
              ...
              <div className="flex-1 w-full relative reveal-on-scroll">
                ...
                <div className="relative z-10 w-full aspect-[4/5] bg-[#1a1a1a] overflow-hidden grayscale hover:grayscale-0 transition duration-700 pointer-events-auto group">
                   <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?q=80&w=2000&auto=format&fit=crop" alt="Agency Office" className="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity transform group-hover:scale-105 duration-700" referrerPolicy="no-referrer" />
