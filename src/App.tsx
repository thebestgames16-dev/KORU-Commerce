...
import { MonitorSmartphone, Search, PenTool, LayoutTemplate, Share2, Rocket, ArrowRight, Menu, X, Check, Star, MessageSquare } from 'lucide-react';
    ...
    <>
            ...
            <div className="flex-1">
              ...
              <div className="space-y-6 mb-16 reveal-on-scroll" style={{ transitionDelay: "200ms" }}>
                <div className="flex items-center gap-4">
                  <div className="w-8 h-8 rounded-full bg-[#C8A84B]/10 flex items-center justify-center text-[#C8A84B]"><Check size={18} /></div>
      ...
      <section className="py-32 px-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-8 relative">
          ...
          {[{
            num: "01", title: "Discovery Call", desc: "Wir lernen uns kennen, analysieren deinen Status Quo und definieren die exakten Ziele für dein Wachstum."
          },{
            num: "02", title: "Konzept & Design", desc: "Wir kreieren ein visionäres Figma-Layout, das deine Marke perfekt in Szene setzt und User führt."
          },{
            num: "03", title: "Entwicklung", desc: "Pixel-perfekte Umsetzung mit modernstem Tech-Stack. Schnell, sicher, responsive und suchmaschinenoptimiert."
          },{
            num: "04", title: "Launch & Wachstum", desc: "Wir bringen das Projekt live. Doch hier fängt es erst an: Mit SEO & Wartung sorgen wir für stete Skalierung."
          }].map((step, idx) => (
